...
| -------------------- | ------- |
| FHIR version         | r4 |
| Implementation Guide | [http://hl7.org.au/fhir](http://hl7.org.au/fhir) |
| Profile URL          |[http://hl7.org.au/fhir/StructureDefinition/au-patient](http://hl7.org.au/fhir/StructureDefinition/au-patient)|

### Dependency List

- ballerinax/health.fhir.r4
- ballerinax/health.fhirr4
- ballerinax/health.fhir.r4.aubase410
...
Pull the template from central
    ...
    ` bal new -t vijay/health.fhir.r4.aubase410.patient PatientAPI `
...
- Add profile type to the aggregated resource type. Eg: `public type Patient r4:Patient|<Other_Patient_Profile>;`.
    ...
    - Eg: `profiles: ["http://hl7.org.au/fhir/StructureDefinition/au-patient", "new_profile_url"]`
